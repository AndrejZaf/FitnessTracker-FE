            ...
            <div className="align-items-center g-0 row">
              <div className="col-xl-5 col-lg-6 col-md-12">
                <div className="py-5 py-lg-0">
                  ...
                  <Link
                    to="/exercises"
                    className="btn btn-success purple-button"
                  >
                    Browse Exercises
                  </Link>{" "}
          ...
          <div className="row g-4 py-5 row-cols-1 row-cols-lg-3">
            ...
            <div className="col d-flex align-items-start">
              ...
              <div>
                ...
                <p>
                  ...
                  exercise you can set rest period, weight for doing the
            ...
            <div className="col d-flex align-items-start">
              ...
              <div>
                <h2>Programs</h2>
                <p>
                  Combine multiple workouts in order to create a program.
                  Maximize your potential and reach your goals as soon as
                  possible.
                </p>
