...
export default function TermsConditions() {
  return (
    <div className="container">
      ...
      <p>Welcome to Fitnessfy!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of Fitnessfy's Website, located at localhost:3000.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Fitnessfy if you do not agree to take
      ...
      <p>
        We employ the use of cookies. By accessing Fitnessfy, you agreed to use
        cookies in agreement with the Fitnessfy's Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, Fitnessfy and/or its licensors own the
        intellectual property rights for all material on Fitnessfy. All
        intellectual property rights are reserved. You may access this from
        Fitnessfy for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from Fitnessfy</li>
        <li>Sell, rent or sub-license material from Fitnessfy</li>
        <li>Reproduce, duplicate or copy material from Fitnessfy</li>
        <li>Redistribute content from Fitnessfy</li>
      </ul>
      ...
      <p>
        ...
        Fitnessfy does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of Fitnessfy,its agents and/or affiliates. Comments reflect the
        views and opinions of the person who post their views and opinions. To
        the extent permitted by applicable laws, Fitnessfy shall not be liable
      ...
      <p>
        Fitnessfy reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant Fitnessfy a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Fitnessfy; and (d) the link is
      ...
      <p>
        ...
        e-mail to Fitnessfy. Please include your name, your organization name,
      ...
      <p>
        No use of Fitnessfy's logo or other artwork will be allowed for linking
